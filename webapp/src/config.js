...
config = {
  ...
  exclude_teams: function (team) {
    if ([1000, 1001, 1002].indexOf(team.getId()) >= 0) return true;
    return false;
  },
  ...
  award_animation_speeds: [
    {
      ...
      fastFlipSpeed: 1200,
      slowFlipSpeed: 2000,
      utuSpeedFunc: function (up_cnt) {
        return Math.min(500 + up_cnt * 100, 2000);
      },
    },
    {
      solved: 9,
    ...
    },
    {
      ...
      slowFlipSpeed: 300,
      utuSpeedFunc: function (up_cnt) {
        return Math.min(250 + up_cnt * 50, 3000);
      },
    },
    {
      solved: 0,
      ...
      slowFlipSpeed: 300,
      utuSpeedFunc: function (up_cnt) {
        return Math.min(150 + up_cnt * 30, 1000);
      },
    },
  ],
